//! This is solana program on the Optimex protocol.
//! 
//! The participants on the Optimex protocol take actions on Solana blockchain will interact with this program.
...
#[cfg(feature = "default")]
#[program]
pub mod optimex_sol_smartcontract {
    use super::*;
    ...
    pub fn settlement<'c: 'info, 'info>(
        ...
        settle_args: SettlementArgs,
    ) -> Result<()> {
        handler_settlement(ctx, settle_args)
    }
