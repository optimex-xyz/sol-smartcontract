 ...
 */
export async function getTradeDetailData(tradeId: string, connection: Connection, commitment: Commitment = 'confirmed') {
 ...
 */
export async function getWhitelistTokenData(token: PublicKey, connection: Connection, commitment: Commitment = 'confirmed') {
    const onchainProgram = await getOptimexProgram(connection);
 ...
 */
export async function getPaymentReceiptData(paymentReceiptPda: PublicKey, connection: Connection, commitment: Commitment = 'confirmed') {
    const onchainProgram = await getOptimexProgram(connection);
    try {
...
export async function getFeeReceiverData(feeReceiver: PublicKey, connection: Connection, commitment: Commitment = 'confirmed') {
    const onchainProgram = await getOptimexProgram(connection);
