...
export const getOffchainProgram = () => {
  ...
  const provider = new anchor.AnchorProvider(new Connection('http://127.0.0.1:8899'), {} as any, {
    commitment: 'confirmed',
  })
  const program = new anchor.Program(IDL as OptimexSolSmartcontract, provider)
