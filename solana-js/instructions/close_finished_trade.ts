...
export async function createCloseFinishedTradeInstructions(params: CloseFinishedTradeInstructionParam) {
    ...
    const closeIns = await onchainProgram.methods.closeFinishedTrade({
        ...
        .accounts({
            ...
            userTokenAccount: tokenPubkey ? await getAssociatedTokenAddress(tokenPubkey, userTradeDetailData.userPubkey, true) : null,
        })
        .instruction();
