...
export async function createSettlementInstructions(params: SettlementInstructionParam) {
  ...
  const depositIns = await onchainProgram.methods
    .settlement({
 ...
 */
export async function createNonceAdvanceInstruction(
  params: Pick<SettlementInstructionParam, 'mpcPubkey' | 'userEphemeralPubkey'>
) {
...
export type UserPresignSettlementTransactionParam = Omit<SettlementInstructionParam, 'userEphemeralPubkey'> & {
  userEphemeral: Keypair
}
 ...
 */
export async function createUserPresignSettlementTransactionAndSerializeToString(
  params: UserPresignSettlementTransactionParam
): Promise<string> {
...
export async function createSettlementTransaction(
  params: Omit<UserPresignSettlementTransactionParam, 'userEphemeral'> & { userEphemeralPubkey: PublicKey }
) {
 ...
 * @returns A string of the transaction
 */
export async function createSettlementTransactionAndSerializeToString(
  params: Omit<UserPresignSettlementTransactionParam, 'userEphemeral'> & { userEphemeralPubkey: PublicKey }
): Promise<string> {
